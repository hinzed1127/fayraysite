...
export default function Shows() {
	...
	const bandcampLink = 'https://bandcamp.com/EmbeddedPlayer/track=1513169463/size=large/bgcol=ffffff/linkcol=333333/tracklist=false/transparent=true/';
	return (
		<div>
			<h1 className='shows-header'>Next Show:</h1>
			<h2 className='shows-header'>
				Fay Ray w/ Melvin Knight and the Amber Sky
			</h2>
			<div className='shows-container'>
				<div className='show-poster'>
					<iframe
						title='Melvin Knight Album Player'
